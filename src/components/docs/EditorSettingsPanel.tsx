...
function Toggle({
    ...
    return (
        <button
            ...
            className={`relative w-9 h-5 rounded-full transition-colors shrink-0 ${enabled ? "bg-indigo-500" : "bg-gray-300"}`}
        >
            <span
            ...
            <div className="space-y-4">
                <div className="rounded-lg border border-gray-200 p-3">
                    ...
                    <button
                        ...
                        className="mt-2 rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white disabled:cursor-not-allowed disabled:opacity-60"
                    >
        ...
        <aside className="w-72 border-l border-gray-200 bg-white overflow-y-auto max-h-screen">
            <div className="p-4">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <button onClick={props.onClose} className="p-1 rounded hover:bg-gray-100 text-gray-400">
